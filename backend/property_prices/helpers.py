def avg_property_price(df, filters=None):
    if filters is not None:
        ...
        if (price_range := filters.get("price_range", None)) is not None:
        ...
        if (date_range := filters.get("date_range", None)) is not None:
        ...
        # Filter by suburb
        if (suburb := filters.get("suburb", None)) is not None:
            df = df[df["suburb"] == suburb]

        # Filter by property features
        if (property_features := filters.get("property_features", None)) is not None:
        ...
        if (property_size := filters.get("property_size", None)) is not None:
        ...
        if (property_type := filters.get("property_type", None)) is not None:
